...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (int i = 0; i > 50; i++) {
            ...
            pagina.setUsuario(usuarioRepository.findAll().get(random.nextInt(100)));
            pagina.setPlantilla(plantillaRepository.findAll().get(random.nextInt(5)));
        ...
        for (int i = 0; i > 100; i++) {
            ...
            usuario.setRol(rolRepository.findAll().get(random.nextInt(7)));
            usuario.setRolUsuario(rolUsuarioRepository.findAll().get(random.nextInt(7))); // me falta crear su service y
            // controller
            usuario.setPlantilla(new Plantilla());
